$(document).ready(async function () {
 ...
 /* $("#unfollow").addClass("d-none");*/
            ...
            $.ajax({
                ...
                success: function (data, status, xhr) {
                    ...
                    $.each(data, function (index, value) {
                        var listItem = $("<li>");
                        var link = $("<a>")
                            .attr("href", "/Comics?ComicId=" + value["comicId"])
                            .text(value["comicName"]);
  ...
  $("#addComic").on("click", "button.btn-primary", function () {
    ...
    $("#addNewChapter").on("show.bs.modal", async function (event) {
        // Button that triggered the modal
        const button = event.relatedTarget;
        const comicId = button.getAttribute("data-bs-comicId");
        $("button#addChapter").on("click", async function () {
            var chapter = {
            ...
            $.ajax({
                ...
                success: async function (data, status, xhr) {
                    $("#addNewChapter").addClass("disabled");
                ...
                error: (e) => {
                    if (e.status == 409) {
                        ...
                        $("#addNewChapter").removeClass("disabled");
